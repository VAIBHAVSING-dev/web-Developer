...
var periodTick = Math.floor(countDownDate / 180);
if(lastGamePeriodTick === null){
lastGamePeriodTick = periodTick;
}
if(periodTick !== lastGamePeriodTick){
lastGamePeriodTick = periodTick;
refreshGameState();
setTimeout(refreshGameState, 5000);
}
if(distance<=30)
{
