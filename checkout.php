...
error_reporting(1);
if (empty($_SESSION['mobile']) || empty($_SESSION['frontuserid'])) {
echo "<script> 
  ...
  <div id="home" class="tab-pane fade in active">
        ...
        <div class="box" style="margin-bottom: 0;">        
            <p>
                ...
                <span class="value">6203367131@ybl</span>
                <button class="btn copyBtn" data-clipboard-text="6203367131@ybl">Copy</button>
            </p>
  ...
  <div id="menu1" class="tab-pane fade">    
        ...
        <div class="box" style="margin-bottom: 0;">
            ...
            <p>
                ...
                <span class="value">110058126518</span>
                <button  class="btn copyBtn" data-clipboard-text="110058126518">Copy</button>
            </p>
            <p>
                <span class="label">IFSC Code&nbsp;:</span>
                <span class="value">CNRB0006342</span>
                <button class="btn copyBtn" data-clipboard-text="CNRB0006342">Copy</button>
            </p>
             <p>
                <span class="label">Bank Name&nbsp;:</span>
                <span class="value">Canara Bank</span>
                <button class="btn copyBtn" data-clipboard-text="Canara Bank">Copy</button>
            </p>
             <p>
                <span class="label">Name&nbsp;:</span>
                <span class="value">VIBHAY KUMAR</span>
                <button class="btn copyBtn" data-clipboard-text="VIBHAY KUMAR">Copy</button>
            </p>
        </div>    
  </div>
</div>
